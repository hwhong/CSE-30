 ...
 */
 	...
 	.global filenameCompare	! Declares the symbol to be globally visible so
				! we can call this function from other modules
	.section ".text"
	
/*
 * Function name: filenameCompare( void const * p1, void const * p2 )
 * Function prototype: int filenameCompare( void const * p1, void const * p2 )
 * Description: sort based on filename of structs
 * Parameters:
